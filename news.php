                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                ...
                                $query=mysqli_query($con,"select news.id as pid,news.title as posttitle,
                                    news.location as location, news.img as newsImg,tblcategory.CategoryName as category,tblcategory.id as cid,news.description as postdetails,news.date as postingdate from news  join tblcategory on tblcategory.id=news.category_id  order by news.date desc");
...
?>
                            ...
                            <div class="blog_details">
                                <a class="d-inline-block" href="single_blog.php?nid=<?php echo htmlentities($row['pid'])?>">
