...
<body>
                                ...
                                <div class="main-menu  d-none d-lg-block">
                                    <nav>
                                        <ul id="navigation">
                                            ...
                                            <li><a class="active" href="contact.php">Контакты</a></li>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">Как связаться с администрацией?</h2>
                    </div>
                    ...
                    <div class="col-lg-3 offset-lg-1">
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>admin.admin@gmail.com</h3>
                                <p>Отправь свои пожелание в любое время!</p>
                            </div>
                        </div>
                    </div>
                </div>
